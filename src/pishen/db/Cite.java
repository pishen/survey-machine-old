...
public class Cite extends RelationshipShell {
	...
	//create new Cite
	protected Cite(Relationship rel, DBHandler dbHandler, String citation) {
		super(rel, dbHandler);
	...
	protected Cite(Relationship rel, DBHandler dbHandler){
		super(rel, dbHandler);
	...
	public Record getStartRecord(){
		return new Record(super.getStartNode(), dbHandler);
	}
	
	public Record getEndRecord(){
		return new Record(super.getEndNode(), dbHandler);
	}
